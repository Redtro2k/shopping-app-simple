      ...
      <form class="mt-12">
        <section aria-labelledby="cart-heading">
          ...
          <ul role="list" class="border-t border-b border-gray-200 divide-y divide-gray-200">
            <li v-for="product in add_product" :key="product.id" class="flex py-6">
              <div class="flex-shrink-0">
                <img :src="product.imageSrc" :alt="product.imageAlt" class="w-24 h-24 rounded-md object-center object-cover sm:w-32 sm:h-32" />
              </div>
              ...
              <div class="ml-4 flex-1 flex flex-col sm:ml-6">
                ...
                <div class="mt-4 flex-1 flex items-end justify-between">
                  ...
                  <div class="ml-4">
                    <Link :href="`products/delete/${product.id}`" class="text-sm font-medium text-indigo-600 hover:text-indigo-500">
                      <span>Remove</span>
                    </Link>
                  </div>
                </div>
        ...
        <section aria-labelledby="summary-heading" class="mt-10">
          ...
          <div>
            <dl class="space-y-4">
              <div class="flex items-center justify-between">
                ...
                <dd class="ml-4 text-base font-medium text-gray-900">₱{{total_product[0] == null ? 0 : total_product[0].price}}</dd>
              </div>
            </dl>
          ...
          <div class="mt-6 text-sm text-center">
            <p>
              or <Link href="/" class="text-indigo-600 font-medium hover:text-indigo-500">Continue Shopping<span aria-hidden="true"> &rarr;</span></Link>
            </p>
          </div>
        </section>
      </form>
